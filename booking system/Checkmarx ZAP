...
* URL: http://localhost:8000/register
  * Method: `POST`
  * Parameter: `username`
  * Attack: `biden AND 1=1 -- `
  * Evidence: ``
  * Other Info: `The page results were successfully manipulated using the boolean conditions [biden AND 1=1 -- ] and [biden AND 1=2 -- ]
...
* URL: http://localhost:8000/register
  ...
  * Attack: `biden OR 1=1 -- `
  * Evidence: ``
  * Other Info: `The page results were successfully manipulated using the boolean conditions [biden AND 1=1 -- ] and [biden OR 1=1 -- ]
The parameter value being modified was NOT stripped from the HTML output for the purposes of the comparison.
